...
public class TagsAPI: APIBase {
  ...
  "status" : ""
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    public class func v1UserTagsPost(body body: UserTag, accessToken: String? = nil, userId: Int32? = nil, completion: ((data: CommonResponse?, error: ErrorType?) -> Void)) {
        v1UserTagsPostWithRequestBuilder(body: body, accessToken: accessToken, userId: userId).execute { (response, error) -> Void in
            completion(data: response?.body, error: error);
        }
    }
  ...
  "status" : ""
     ...
     - returns: RequestBuilder<CommonResponse> 
     */
    public class func v1UserTagsPostWithRequestBuilder(body body: UserTag, accessToken: String? = nil, userId: Int32? = nil) -> RequestBuilder<CommonResponse> {
