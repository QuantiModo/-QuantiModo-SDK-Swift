...
public class StudyText: JSONEncodable {
    ...
    /** Ex: Very Distracting Time data was primarily collected using &lt;a href&#x3D;\&quot;https://www.rescuetime.com/rp/quantimodo/plans\&quot;&gt;RescueTime&lt;/a&gt;. Detailed reports show which applications and websites you spent time on. Activities are automatically grouped into pre-defined categories with built-in productivity scores covering thousands of websites and applications. You can customize categories and productivity scores to meet your needs.&lt;br&gt;Video Activities data was primarily collected using &lt;a href&#x3D;\&quot;https://www.rescuetime.com/rp/quantimodo/plans\&quot;&gt;RescueTime&lt;/a&gt;. Detailed reports show which applications and websites you spent time on. Activities are automatically grouped into pre-defined categories with built-in productivity scores covering thousands of websites and applications. You can customize categories and productivity scores to meet your needs. */
    public var dataSourcesParagraphForCause: String?
    /** Ex: Very Distracting Time data was primarily collected using &lt;a href&#x3D;\&quot;https://www.rescuetime.com/rp/quantimodo/plans\&quot;&gt;RescueTime&lt;/a&gt;. Detailed reports show which applications and websites you spent time on. Activities are automatically grouped into pre-defined categories with built-in productivity scores covering thousands of websites and applications. You can customize categories and productivity scores to meet your needs.&lt;br&gt;Video Activities data was primarily collected using &lt;a href&#x3D;\&quot;https://www.rescuetime.com/rp/quantimodo/plans\&quot;&gt;RescueTime&lt;/a&gt;. Detailed reports show which applications and websites you spent time on. Activities are automatically grouped into pre-defined categories with built-in productivity scores covering thousands of websites and applications. You can customize categories and productivity scores to meet your needs. */
    public var dataSourcesParagraphForEffect: String?
    /** Ex: Sleep Quality Predicts Higher Overall Mood */
    public var lastCauseDailyValueSentenceExtended: String?
    /** Ex: Sleep Quality Predicts Higher Overall Mood */
    public var lastCauseAndOptimalValueSentence: String?
    /** Ex: Sleep Quality Predicts Higher Overall Mood */
    public var lastCauseDailyValueSentence: String?
    /** Ex: Sleep Quality Predicts Higher Overall Mood */
    public var optimalDailyValueSentence: String?
    /** Ex: Sleep Quality Predicts Higher Overall Mood */
    ...
    public var studyInvitation: String?
    /** Does Remeron affect Overall Mood? */
    public var studyQuestion: String?
    ...
    func encodeToJSON() -> AnyObject {
        ...
        nillableDictionary["dataSourcesParagraphForCause"] = self.dataSourcesParagraphForCause
        nillableDictionary["dataSourcesParagraphForEffect"] = self.dataSourcesParagraphForEffect
        nillableDictionary["lastCauseDailyValueSentenceExtended"] = self.lastCauseDailyValueSentenceExtended
        nillableDictionary["lastCauseAndOptimalValueSentence"] = self.lastCauseAndOptimalValueSentence
        nillableDictionary["lastCauseDailyValueSentence"] = self.lastCauseDailyValueSentence
        nillableDictionary["optimalDailyValueSentence"] = self.optimalDailyValueSentence
        ...
        nillableDictionary["studyInvitation"] = self.studyInvitation
        nillableDictionary["studyQuestion"] = self.studyQuestion
