...
public class UserTag: JSONEncodable {
    ...
    func encodeToJSON() -> AnyObject {
        ...
        nillableDictionary["taggedVariableId"] = self.taggedVariableId
        nillableDictionary["tagVariableId"] = self.tagVariableId
