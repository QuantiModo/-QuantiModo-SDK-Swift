...
public class UserVariable: JSONEncodable {
    ...
    func encodeToJSON() -> AnyObject {
        ...
        nillableDictionary["experiment_start_time"] = self.experiment_start_time?.encodeToJSON()
        nillableDictionary["experiment_end_time"] = self.experiment_end_time?.encodeToJSON()
